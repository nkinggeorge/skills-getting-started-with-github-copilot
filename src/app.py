...
activities = {
    ...
    "Soccer Team": {
        "description": "Team soccer training and seasonal matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "maya@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice drills, games, and fitness work for basketball enthusiasts",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, scene study, and stage production skills",
    ...
    "Math Olympiad": {
        "description": "Challenge mathematical problem solving and competition prep",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
